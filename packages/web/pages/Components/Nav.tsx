                ...
                <nav>
                    <div className="navCont">
                        <div className="logo-cont">
                            <img src='https://i.ibb.co/cksFpPJ/Group-4.png' className="logo" />
                        </div>
                        ...
                        <div className="homeCont2">
                            ...
                            <p>
                                <a className={active3} href="/Components/Playercard">
                                    {' '}
                                    Explore{' '}
                                </a>{' '}
                            </p>
                        ...
                        <div onClick ={logout} className={`homeCont3${loggedin}`}>
                            <a>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
